...
<#21>
<?php
if (!$ilDB->tableColumnExists('rep_robj_xvit_mat', 'vit_id')) {
    $ilDB->addTableColumn('rep_robj_xvit_mat', 'vit_id',
        [
            'type'    => ilDBConstants::T_INTEGER,
            'length'  => 4,
            'notnull' => false,
...
<#23>
<?php
if (!$ilDB->tableColumnExists('rep_robj_xvit_recs', 'app_start')) {
    $ilDB->addTableColumn('rep_robj_xvit_recs', 'app_start',
            [
                'type' => ilDBConstants::T_INTEGER,
                'length' => 4,
                'notnull' => false,
